        ...
        return (
            <div className="workscontainer">
                ...
                <h1 className="workstitle">How It Works</h1>
                    <img className="worksimg desktop-hide" src={handshake} alt="handshake"/>
                    <div className="worksc">
                        ...
                        <h4>Start getting your projects done today!</h4>
                    </div>
                    <img className="worksimg mobile-hide" src={handshake} alt="handshake"/>
                    ...
                    <div className="worksc">
                        ...
                        <h4>Start growing your freelance business today!</h4>
                    </div>
                    <img className="worksimg mobile-hide desktop-hide" src={computer} alt="developer" />
                </div>
            </div>
        )
    }
